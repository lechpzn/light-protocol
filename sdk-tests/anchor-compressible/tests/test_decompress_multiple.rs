...
async fn test_create_and_decompress_two_accounts() {
    ...
    let (compressed_token_account, _) = create_user_record_and_game_session(
        &mut rpc,
        &combined_user,
        &program_id,
        &config_pda,
    ...
    let (_, compressed_token_account_address) = anchor_compressible::get_ctoken_signer_seeds(
        &combined_user.pubkey(),
    ...
    compress_token_account_after_decompress(
        ...
        compressed_token_account.token.mint,
        compressed_token_account.token.amount,
        &combined_user_record_pda,
        &combined_game_session_pda,
        combined_session_id,
    ...
    let instruction =
        light_compressible_client::CompressibleInstruction::decompress_accounts_idempotent(
            ...
            &anchor_compressible::accounts::DecompressAccountsIdempotent {
                ...
                compressed_token_rent_payer_and_recipient: CTOKEN_RENT_PAYER_AND_RECIPIENT,
...
async fn create_user_record_and_game_session(
    ...
    (compressed_token_account, mint_signer.pubkey())
}
...
async fn compress_record(
    ...
    let instruction = CompressibleInstruction::compress_accounts_idempotent(
        ...
        &anchor_compressible::accounts::CompressAccountsIdempotent {
            ...
            compressed_token_program: compressed_token::id(),
            compressed_token_cpi_authority: compressed_token::cpi_authority(),
            compressed_token_rent_recipient: payer.pubkey(),
...
async fn compress_token_account_after_decompress(
    ...
    assert_eq!(
        compressed_token.token.owner, token_account_address,
